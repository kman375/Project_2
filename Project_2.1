...
int main(int argc, char** argv) {
    ...
    do{
        ...
        //Gets a input from the user
            ...
            if (cGuess == "high" && total1 < total2){
                correct = true; //changes the boolean value that will add a point to the computer
            }
            else if (cGuess == "low" && total1 > total2){
                correct = true;
            }
            else if (cGuess == "same" && total1 == total2){
                correct = true;
            }
            else{
                correct = false;
        ...
        //Displays if they were right or wrong  
            if (guess == "high" && total1 < total2){
                ...
                balance = balance + bet; //adds to the balance by 10
                streak++;
                cout << "You have a streak of " << streak << endl;
                counter++; //adds a point to the player
            }
